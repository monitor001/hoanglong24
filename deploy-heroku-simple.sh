...
# MiniCDE Heroku Deployment Script - Simple Version
# Deploy frontend and backend to Heroku

set -e

echo "🚀 Starting MiniCDE Heroku Deployment..."
...
print_status "Backend: https://$BACKEND_APP_NAME.herokuapp.com"
print_status "Frontend: https://$FRONTEND_APP_NAME.herokuapp.com"
print_status "Main site: https://qlda.hoanglong24.com"
