...
import { 
  ...
  Table, Modal, Form, Input, Select, Spin, message,
  Switch
} from 'antd';
import { 
...
const UserDetail: React.FC = () => {
  ...
  // Check if current user can edit this user using permissions from database
  // Removed permission system - always allow edit
  ...
  const canEdit = canEditUsers || loggedInUser?.id === id;
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        {canEdit && (
          <Space>
            ...
            {canEditUsers && loggedInUser?.id !== id && (
      ...
      >
        ...
        >
          ...
          {canEditUsers && (
            ...
            >
              <Select>
                <Option value={ROLES.ADMIN}>{t('roles.admin')}</Option>
