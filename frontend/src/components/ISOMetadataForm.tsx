  ...
  const fetchMetadataFields = async () => {
    ...
    try {
      ...
      setMetadataFields([
        ...
        { id: 'zone', name: 'Zone', nameVi: 'Khu vực', isRequired: false, isActive: true },
        { id: 'level', name: 'Level', nameVi: 'Cấp độ', isRequired: false, isActive: true },
        ...
        { id: 'number', name: 'Number', nameVi: 'Số hiệu', isRequired: false, isActive: true }
      ]);
    }
    setLoading(false);
  };
      ...
      <Col span={12} key={field.id}>
        <Form.Item
          ...
          label={
            <span>
              {field.nameVi}
              {field.isRequired && <span style={{ color: 'red', fontWeight: 'bold' }}> *</span>}
            </span>
          }
          rules={field.isRequired ? [{ required: true, message: `${field.nameVi} là bắt buộc theo chuẩn ISO 19650!` }] : []}
